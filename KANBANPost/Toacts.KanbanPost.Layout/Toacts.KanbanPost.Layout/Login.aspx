<%@ Page Language="C#" MasterPageFile="~/Template/Production.Master" AutoEventWireup="true"  CodeBehind="Login.aspx.cs" Inherits="Toacts.KanbanPost.Layout.Login" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div id="Panel1" class="Panel_Login" style="text-align:center;margin-left: auto;margin-right: auto;width: 390px;margin-top:220px;border:1px solid #cccccc;border-radius:15px;box-shadow: 0px 0px 9px rgba(0,0,0,0.15);background:white;">	
