<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Site1.Master" AutoEventWireup="true" CodeBehind="PDLosttime.aspx.cs" Inherits="Toacts.KanbanPost.Layout.Masters.PDLosttime" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(function () {
        ...
        $('#ma_part').datagrid({
            ...
            { field: 'description', title: 'Description', width: 240, align: 'left', editor: 'text' },
            { field: 'losttime', title: 'Lost time', width: 190, align: 'rigleftht', editor: 'text' },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="main-contain-inner">       
        <div class="o-1"  >
	            <h1 id="h2"  >Losttime Master Data</h1>
        ...
        <div style="width:630px;margin-left:auto;margin-right:auto;">
	        <table id="ma_part" title="Issued KANBAN" style="width:630px;height:auto;"
			        url="/Handler/LosttimeMasterHandler.axd" 
		        ...
		        <thead>
			        ...
			        <tr>
				        ...
				        <th field="losttime" width="200" >Lost time</th>
			        </tr>
		        </thead>
	        </table>
        </div>
