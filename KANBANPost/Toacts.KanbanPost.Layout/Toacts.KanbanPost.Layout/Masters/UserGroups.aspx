<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Site1.Master" AutoEventWireup="true" CodeBehind="UserGroups.aspx.cs" Inherits="Toacts.KanbanPost.Layout.Masters.UserGroups" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(function () {
        ...
        $('#ma_part').datagrid({
            ...
            { field: 'rolename', title: 'Role Name', width: 240, align: 'left', editor: 'text' },
            { field: 'description', title: 'description', width: 190, align: 'left', editor: 'text' },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="main-contain-inner">       
        <div class="o-1"  >
	            <h1 id="h2"  >Operator Group Master Data</h1>
        ...
        <div style="width:630px;margin-left:auto;margin-right:auto;" >
	        <table id="ma_part" title="Issued KANBAN" style="width:630px;height:auto;"
			        url="/Handler/OperatorRoleMasterHandler.axd" 
		        ...
		        <thead>
			        ...
			        <tr>
				        ...
				        <th field="rolename" width="250">Role Name</th>
