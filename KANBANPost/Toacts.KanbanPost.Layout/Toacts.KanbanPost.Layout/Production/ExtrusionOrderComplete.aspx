...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="production-contain" >        
	    ...
	    <h1 id="h2" >Complete Extrusion Work Order</h1>
                ...
                <table class="highligh-row" >
                    ...
                    <tr>
                        <td>    
                            ...
                            <span class="lot-information" >Extrusion Line:</span><span  class="lot-information data"  >01</span>
                            <span class="lot-information"  >Production by:</span><span  class="lot-information data"  >User01</span>
                        </td>
                    </tr>
            ...
            <div  style="margin-bottom:20px;">
                ...
                <hr/>
                 <table  class="highligh-row"  >
                    ...
                    <tr>
                        <td>                   
                            <span class="lot-information" style="margin-left:25px;" >Actual End Date:</span><input type="text" class="easyui-datebox"  /><span class="lot-information" style="margin-left:10px;">Start Time</span>
                    ...
                    <tr>
                        <td>
                            <span class="lot-information" style="margin-left:25px;" >FG:</span><input type="text" /><span>pcs.</span>
                            <span class="lot-information" >NG:</span><span  class="lot-information data" >0</span><span   class="lot-information data">pcs.</span>
                        </td>
                    </tr>
                 </table>
            </div>
	        <div class="page-options-nav button-group" style="margin-top:0px;">
