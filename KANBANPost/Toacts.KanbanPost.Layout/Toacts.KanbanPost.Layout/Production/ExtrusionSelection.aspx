...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="width:650px;margin-left:auto;margin-right:auto;margin-top: 200px;border: solid 1px #cccccc;border-radius:15px;box-shadow: 0px 0px 9px rgba(0,0,0,0.15);padding: 50px">
		    ...
		    <input type="button"  class="fancy-button ui-button ui-widget ui-state-default ui-corner-all" style="width: 100%;height: 70px;margin-bottom:40px;" value="Create New Work Order" />	
            <hr style="margin-top:-20px;" />
            <span style="position:fixed;top: 380px;width:550px;text-align: center;font-weight:bold;color:#2e6e9e;">OR</span>
		    <input type="button"  class="fancy-button ui-button ui-widget ui-state-default ui-corner-all" style="width: 100%;height: 70px;"  value="Complete Work Order" />	
    </div>
</asp:Content>
