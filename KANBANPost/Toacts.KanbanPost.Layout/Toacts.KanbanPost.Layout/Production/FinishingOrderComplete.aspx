 ...
 <div style="width: 930px;padding-top: 10px;border-left: 1px solid #cccccc;border-right: 1px solid #cccccc;position: absolute;height: 100%;padding:0px 27px;" ><br/>      
        <div class="o-1" style="margin-left: auto;margin-right: auto;width: 930px;">             
	        <div class="page-options-nav" style="margin-top:5px;">
                <a href="javascript:void(0)">Finishing Process Selection</a> 
                <span>></span>
                <a href="javascript:void(0)">Finishing Work Order Complete</a>
	        </div>
        </div>  
        <div style="width:650px;margin-left:auto;margin-right:auto;margin-top: 65px;border: solid 1px #cccccc;border-radius:15px;box-shadow: 0px 0px 9px rgba(0,0,0,0.15);padding: 9px">
                <span style="position:absolute;margin-top:-60px;font-size:28px;color:#428bca">FINISHIG WORK ORDER COMPLETE</span>
		        <input type="text" style="height:100px;width:100%;font-size:50px;" />	
                <span style="position:absolute;margin-top:20px;font-size:14px;color:#428bca;text-align:center;width: inherit;">Please scan KABAN tag for complete work order.</span>
        </div>
        <div style="margin-left:auto;margin-right:auto;width:95%;margin-top:35px;border:solid 1px #cccccc;border-radius: 5px;padding: 5px 0px 40px 0px; ">
            ...
            <div style="padding: 20px 0px;">
                ...
                <br />
                <span  class="lot-information" style="margin-left:25px;" >Start Date:</span><input style="font-size:12px;" type="text" /><span>Start Time</span>
	        ...
	        <div class="page-options-nav" style="float:right;margin-right:20px;">
                <a class="fancy-button filter-button arrow-down" href="javascript:void(0)">Coplete</a> 
                &nbsp;&nbsp;&nbsp;&nbsp;
