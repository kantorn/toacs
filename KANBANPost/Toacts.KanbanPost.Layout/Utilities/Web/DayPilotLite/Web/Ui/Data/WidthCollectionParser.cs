...
namespace Utilities.Web.DayPilotLite.Web.Ui.Data
{
    internal class WidthCollectionParser
    {
        internal static List<int> Parse(string commaSeparatedWidths)
        {
            ...
            {
                list.Add(Convert.ToInt32(w.Trim()));
            }
