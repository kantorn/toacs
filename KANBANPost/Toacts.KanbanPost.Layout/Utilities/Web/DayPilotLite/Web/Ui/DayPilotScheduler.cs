...
using Utilities.Web.DayPilotLite.Utils;
using Utilities.Web.DayPilotLite.Web.Ui.Ajax;
using Utilities.Web.DayPilotLite.Web.Ui.Data;
using Utilities.Web.DayPilotLite.Web.Ui.Enums;
using Utilities.Web.DayPilotLite.Web.Ui.Enums.Scheduler;
using Utilities.Web.DayPilotLite.Web.Ui.Events;
using Utilities.Web.DayPilotLite.Web.Ui.Events.Scheduler;
...
namespace Utilities.Web.DayPilotLite.Web.Ui
{
    ...
    public class DayPilotScheduler : DataBoundControl, IPostBackEventHandler
    {
        ...
        public event BeforeHeaderRenderEventHandler BeforeResHeaderRender;
        ...
        private void DoBeforeResHeaderRender(BeforeHeaderRenderEventArgs args)
        {
        ...
        {
            BeforeHeaderRenderEventArgs ea = new BeforeHeaderRenderEventArgs();
        ...
        private void LoadEventsToDays()
        {
            ...
            else
            {
                if (items != null)
                {
                    ...
                    {
                        Day d = new Day(StartDate, EndDate.AddDays(1), e.Name, e.PK, CellDuration);
