...
namespace Utilities.Web.DayPilotLite.Web.Ui.Events.Calendar
{
    ...
    public class BeforeEventRenderEventArgs : EventArgs
    {
        ...
        /// <summary>
        /// Event column. If <see cref="DayPilotCalendar.ViewType">DayPilotCalendar.ViewType</see> is set to <see cref="ViewTypeEnum.Resources">ViewTypeEnum.Resources</see> it contains column id (<see cref="DayPilotCalendar.DataColumnField">DayPilotCalendar.DataColumnField</see> property). Otherwise it contains day identification in YYYY-MM-DD format. Read-only.
        /// </summary>
