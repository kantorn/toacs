...
namespace Utilities.Web.DayPilotLite.Web.Ui.Events.Scheduler
{
    /// <summary>
    ...
    /// </summary>
    public delegate void RowHeaderColumnWidthChangedEventHandler(object sender, HeaderColumnWidthChangedEventArgs e);
    ...
    /// </summary>
    public class HeaderColumnWidthChangedEventArgs : EventArgs
    {
        internal HeaderColumnWidthChangedEventArgs()
        {
        }
    }
}
